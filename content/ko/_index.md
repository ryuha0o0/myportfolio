    ...
    content:
      ...
      text: |
        <div style="display: flex; flex-direction: column; align-items: center;">
          <img src="assets/media/avatar.jpg" alt="프로필 사진" style="border-radius: 50%; width: 150px; height: 150px; object-fit: cover; margin-bottom: 20px;">          <p style="font-size: 120%; text-align: center;">
            **전공**: 컴퓨터 공학<br>
