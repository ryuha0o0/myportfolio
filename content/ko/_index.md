      ...
      text: |
        <div style="display: flex; justify-content: space-between; align-items: center;">
          ...
          <div style="flex: 1; text-align: left; display: flex; align-items: center;">
            <img src="avatar.jpg" alt="프로필 사진" style="border-radius: 50%; width: 100px; height: 100px; object-fit: cover; margin-right: 20px;">
            <div>
              <p style="font-size: 100%; font-weight: bold;">류하영</p>
              <p style="font-size: 75%;">전북대학교</p>
            </div>
          </div>
          <!-- 오른쪽: 소개 정보 -->
